...
def convert(xml_list, json_file):
    ...
    for index, line in enumerate(xml_list):
        ...
        for obj in get(root, 'object'):
            ...
            # coco数据格式是 x_min, y_min, w, h 这里需要转换成 x_min, y_min, x_max, y_max
...
if __name__ == '__main__':
    classes = ["BoneMan", "Hatter", "FatMan", "LittleMan", "Cowboy", "Werewolf","Bena","Papjo","Kokoyi",
