...
class Config:
    def __init__(self):
        ...
        self.train_txt = r'D:\py_pro\easy-pytorch-CenterNet\data\kalete\\train.txt'   # 训练集路径
        self.val_txt = r'D:\py_pro\easy-pytorch-CenterNet\data\kalete\\val.txt'   # 验证集路径
        ...
        self.test_dir = r'D:\py_pro\easy-pytorch-CenterNet\data\coco\\val2017'  # 存放测试图片的文件夹
